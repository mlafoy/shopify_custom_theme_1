...
theme.Product = (function() {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initBreakpoints: function() {
      ...
      /*
      // SV -  Thumbail slider enabled on desktop as well #4069
    ...
    _updateAvailability: function(evt) {
      ...
      /* SV 08.20.19 */
      __product.updateETA(evt.variant);
      __product.updateVariantStockInfo(evt.variant);
      __product.updateVariantDiscount(evt.variant);
    },
...
(function($) {
  function getProducts(p_options) {
    return new Promise(function(resolve, reject) {
      $.get('/collections/all?view=json', function(response) {
        var $products = $(response).find('#products-list li');
  ...
  function loadProducts($products) {
    ...
    var $filterCount = $('.filters-toolbar__product-count');
    
    if ($products.length == 0) {
      $productsList.html('<p>No matching results. </p>');
    }
